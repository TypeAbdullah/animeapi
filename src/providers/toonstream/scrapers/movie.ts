...
import type { AnimeCard, Cast, Genre, Tag } from "../lib/types.js";
...
export async function movieScraper(slug: string) {
    ...
    try {
        ...
        Cache.set(key, playerIframeUrls, MOVIE_IFRAMES_TTL, true);
