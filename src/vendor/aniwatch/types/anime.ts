...
export type SpotlightAnime = MostPopularAnime & Pick<Top10Anime, "rank"> & {
...
export type AnimeGeneralAboutInfo = Pick<Anime, CommonAnimeProps> & Pick<SpotlightAnime, "description"> & {
